...
// Organiza: elimina duplicados por título y ordena alfabéticamente
function organizeContent<T extends ContentItem>(items: T[]): T[] {
  ...
  return unique.sort((a, b) => a.title.localeCompare(b.title, 'es', { sensitivity: 'base' }));
}

const rawMockMovies: ContentItem[] = [
  {
    id: 'Nadie 2',
    title: 'Nadie 2',
    year: 2025,
...
export const mockMovies: ContentItem[] = organizeContent(rawMockMovies);
